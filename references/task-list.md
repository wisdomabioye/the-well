...
| 4     | Wallet authentication             | in_progress | Better Auth hashed-session adapter boundary requires approval  |
| 5     | Authorization and account records | pending     | Wallet authentication                                          |
